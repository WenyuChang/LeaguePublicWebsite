	...
	public partial class top : System.Web.UI.UserControl
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
            ...
            + System.AppDomain.CurrentDomain.BaseDirectory + @"App_Data\Company_Data.mdf" + ";Integrated Security=True;User Instance=True";
				...
				topmemu.Text+="<span class='l2'> </span>|<span class='l2'> </span><a class='rlk2' href='default.aspx'>首页</a>";
				while(r1.Read())
				{
				...
				topmemu.Text+="<span class='l2'> </span>|<span class='l2'> </span><a class='rlk2' href='guestbook.aspx'>留言</a>";
				r1.Close();
				conn.Close();
			}
		}
